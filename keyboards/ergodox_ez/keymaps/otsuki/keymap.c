...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_LSFT,        KC_Z,        KC_X,   KC_C,   KC_V,   KC_B,   KC_F11,
        KC_NO,          KC_NO,       KC_QUOT,KC_LALT,KC_LGUI,
                                             ALT_T(KC_APP),  KC_LGUI,
                                                             KC_HOME,
                                             KC_SPC, KC_BSPC,KC_FN2,
        // right hand
        KC_RGHT,     KC_6,   KC_7,   KC_8,   KC_9,   KC_0,           KC_MINS,
        KC_MINS,     KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,           KC_BSLS,
                     KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,        KC_QUOT,
        KC_F12,      KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,        KC_RSFT,
                             KC_RGUI,KC_LBRC,KC_RBRC,KC_NO,          KC_NO,
